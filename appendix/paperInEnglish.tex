...
\centering
\vspace{-22pt}
\noindent\hspace{-1.5em}\makebox[\textwidth][l] {\includegraphics[width=1.08\textwidth]{figures/papers_1}}
\end{figure}
\begin{figure}[htbp] 
\centering
\noindent\hspace{-1.5em}\makebox[\textwidth][l] {\includegraphics[width=1.08\textwidth]{figures/papers_2}}
\end{figure}
