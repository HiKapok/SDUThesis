...
\usepackage[a4paper,text={152.058 true mm,246.926 true mm},top= 28 true mm,left=33 true mm,headheight=10 true mm,headsep=6.5 true mm,footskip=8 true mm]{geometry}
                                            % 支持版面尺寸设置
...
%escapeinside=``,
%tabsize=4,xleftmargin=2em,xrightmargin=2em, aboveskip=1em
%}
